#include <iostream>
using namespace std;
typedef struct CONNECTION_DESCRIPTION_1 // структура без выравнивания и не упорядочена
{
    int connection_type;
...
typedef struct CONNECTION_DESCRIPTION_3 // структура без выравнивания, но упорядочена
{
    char connection_name[112];
    unsigned long long ip_adress;
    int connection_type;
